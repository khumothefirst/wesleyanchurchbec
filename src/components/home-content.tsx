    ...
    <>
      ...
      <section className="bg-parchment">
        <div className="mx-auto max-w-6xl px-5 py-20 md:py-28">
          <SectionHead
            eyebrow="The office of the District Bishop"
            title="District Bishop Rev. C.L. Madaza"
            lead="The District Bishop gives pastoral and spiritual oversight to the Wesleyan Church South African National Conference — shepherding the Conference, the districts, and every society gathered under its discipline."
          />
          <div className="mt-12 grid gap-10 md:grid-cols-[20rem_1fr] md:items-start">
            <figure className="border border-border bg-card p-3">
              <img
                ...
                alt="District Bishop Rev. C.L. Madaza in ecclesiastical robes and red stole"
                className="aspect-[4/5] w-full object-cover"
                loading="lazy"
              />
              <figcaption className="label-caps mt-3 text-center text-muted-foreground">
                District Bishop Rev. C.L. Madaza
              </figcaption>
            </figure>
            <div className="space-y-6 text-muted-foreground">
              <p>
                The District Bishop is the supreme pastoral and administrative officer of the
              ...
              <p className="label-caps text-primary">District Bishop · Wesleyan Church SANC</p>
            </div>
          </div>
        </div>
      </section>
